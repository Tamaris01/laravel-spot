...
Route::middleware(['auth:pengelola'])->group(function () {
    ...
    Route::get('/dashboard/cek-notif-parkir', [RiwayatParkirController::class, 'cekNotifParkir'])->name('dashboard.cek.notif.parkir');
    ...
    Route::get('/kelola-kendaraan/{plat_nomor}/edit', [KelolaKendaraanController::class, 'edit'])
