                    ...
                    <div class="col-12 col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 h-100">
                        <div class="upload-photo text-center p-2">
                            <img id="previewProfil"
                                src="https://res.cloudinary.com/dusw72eit/image/upload/{{ $user->foto }}"
                    ...
                    <div class="col-12 col-md-8">
                        <div class="form-group mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="id_pengelola" id="id_pengelola_view" value="{{ $user->id_pengelola}}" class="form-control border border-dark text-black" readonly>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <button type="button" class="btn" style="background-color: #FFDC40; color: #000; width:100px" onclick="showEditForm()">
                                Ubah
                            </button>
                        </div>
                    </div>
    ...
    <div id="editCard" class="row" style="display:none;">
        <div class="col-12">
            <div class="card border border-dark">
                ...
                <div class="card-body">
                    <form action="{{ route('pengelola.profile.update', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="button" class="btn" style="background-color: #fff; color: #000; margin-right: 8px; border: 1px solid #000; width:100px" onclick="cancelEditForm()">Batal</button>
                                    <button type="submit" class="btn" style="background-color: #FFDC40; color: #000; width:100px">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </form>
