...
<div class="container">
    ...
    <div class="row">
        ...
        text-align: center;" role="document">
                                ...
                                <!-- Modal Edit Kendaraan -->
                                <div class="modal fade" id="editModal{{ $data->plat_nomor }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $data->plat_nomor }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <!-- Modal Header -->
                                            <div class="modal-header" style="background-color: #FFDC40;">
                                                <h5 class="modal-title" id="editModalLabel{{ $data->plat_nomor }}">Edit Kendaraan</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="id_pengguna" class="form-control">
                                                                        <option value="" disabled>Pilih ID Pengguna</option>
                                                                        @foreach($penggunaDropdown as $pengguna)
                                                                        <option value="{{ $pengguna->id_pengguna }}"
                                                                            {{ optional($data->penggunaParkir)->id_pengguna == $pengguna->id_pengguna ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <span class="input-group-text"><i class="fas fa-car"></i></span>
                                                                    <input type="text" name="plat_nomor_lama"
                                                                        class="form-control"
