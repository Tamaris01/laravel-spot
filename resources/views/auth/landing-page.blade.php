            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6" data-aos="fade-left">
                    ...
                    <ul class="list-unstyled lead mt-3">
                        ...
                        <li class="mb-2"><i class="bi bi-clock-fill text-danger me-2"></i> Pencatatan lambat & tidak akurat</li>
                        <li class="mb-2"><i class="bi bi-eye-slash-fill text-danger me-2"></i> Pengawasan minim & tidak realtime</li>
                    </ul>
